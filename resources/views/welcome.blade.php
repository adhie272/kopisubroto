...
<body class="bg-brand-cream font-sans text-brand-ink pt-20 sm:pt-16">
    ...
    <nav class="bg-brand-deep text-brand-parchment shadow-lg fixed top-0 w-full h-16 z-40">
        <div class="container mx-auto px-4 sm:px-6 h-full flex justify-between items-center">
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                @if($isAdminStorePreview)
                    <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center gap-2 bg-brand-brown px-3 py-2 rounded-full text-white text-xs font-bold hover:bg-brand-brownDark transition shadow-sm" aria-label="Kembali ke Dashboard">
    ...
    <div id="cartModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
        <div class="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-3xl max-h-[92vh] sm:max-h-[85vh] overflow-hidden shadow-2xl flex flex-col">
            ...
            <div id="cartItemsContainer" class="p-5 sm:p-6 min-h-[160px] overflow-y-auto flex-1">
                <!-- Cart items akan di-load via JavaScript -->
                <p class="text-center text-gray-500">Keranjang kosong</p>
            </div>

            <div class="border-t border-brand-line p-4 sm:p-5 bg-brand-cream sticky bottom-0 space-y-3">
                <!-- Customer Name Input -->
                <div>
                    <label class="block text-sm font-semibold text-brand-ink mb-1">Nama yang Memesan</label>
                    <input type="text" id="customerName" placeholder="Masukkan nama Anda" class="w-full px-3 py-2 border border-brand-line rounded-xl text-brand-deep focus:outline-none focus:ring-2 focus:ring-brand-teal focus:border-transparent">
                </div>

                <!-- Table Number Input -->
                <div>
                    <label class="block text-sm font-semibold text-brand-ink mb-1">Nomor Meja</label>
                    <input type="number" id="tableNumber" placeholder="Masukkan nomor meja" class="w-full px-3 py-2 border border-brand-line rounded-xl text-brand-deep focus:outline-none focus:ring-2 focus:ring-brand-teal focus:border-transparent" min="1">
                </div>

                <!-- Total -->
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 pt-2 border-t border-brand-line">
                    <span class="text-base font-semibold">Total:</span>
                    <span id="cartTotal" class="text-xl font-bold text-brand-deep">Rp 0</span>
                </div>

                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row gap-2">
                    <button id="clearCartBtn" class="flex-1 bg-brand-maroon text-white px-3 py-2 rounded-xl font-semibold hover:opacity-90 transition">
                        Kosongkan Keranjang
                    </button>
                    <button id="orderBtn" class="flex-1 bg-brand-brown text-white px-3 py-2 rounded-xl font-semibold hover:bg-brand-brownDark transition">
                        Pesan
                    </button>
                </div>
            </div>
